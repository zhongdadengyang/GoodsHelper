var local = angular.module('jkuri.timepicker', []);
require('./index.css');

local.directive('ngTimepicker', ['$document', function($document) {
    ...
    return {
        ...
        template: '<input type="text" class="form-control col-md-4" ng-focus="showTimepicker()" ng-value="viewValue" class="ng-timepicker-input" ng-readonly="true">' +
