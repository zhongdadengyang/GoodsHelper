...
var local=angular.module('ui.tour', []);

local.directive('uiTour', ['$timeout', '$parse', function($timeout, $parse){
  return {
    link: function($scope, $element, $attributes) {
      ...
      function showStep(stepNumber) {
        var elm, at, children = $element.children().removeClass('tour-active');
        ...
        if (stepNumber && elm.length) {
          ...
          $timeout(function(){
            ...
            if (elm.attr('overlay') !== undefined) {
              $('.tour-overlay').addClass('tour-active').css({
              ...
              setTimeout(function(){
                $('.tour-overlay').removeClass('tour-active');
              }, 1000);
            }
            offset = {};
